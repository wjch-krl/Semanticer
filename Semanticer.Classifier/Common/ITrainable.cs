...
{
	/// <summary>
	/// Interfejs dla trenowanych klasyfikatorów
	/// </summary>
	public interface ITrainable : IClassifier
	{
	    /// <summary>
	    /// Czyœci zapisane informacje (model powsta³y w wyniku treningu) oraz dokonuje ponownego treningu.
	    /// </summary>
	    /// <param name="data"></param>
	    /// <param name="lang"></param>
	    /// <returns></returns>
	    TimeSpan ReTrain(ITrainingData data);
	}
}
